...
class Address implements Apiable {
	 ...
	 * @param string|null $address_line_3 Address line 3.
	 ...
	 */
	public function __construct( string $address_line_1, string $address_line_2, string $address_line_3, string $administrative_level_1, string $administrative_level_2, string $country_code, string $postal_code, ?array $coordinates ) {
