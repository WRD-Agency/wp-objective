<?php
/**
 * Contains the Club_Singular_Endpoint class.
 *
 ...
 */
class Post_Type_Singular_Endpoint extends Endpoint {
	/**
	 ...
	 */
	public function handle( WP_REST_Request $request ): Apiable|WP_Error|array {
